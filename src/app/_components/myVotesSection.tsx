...
export const MyVotesSection = ()=>{
   ...
   useEffect(()=>{
    ...
    <div className="bg-green-700 rounded-3xl px-2 py-1 lg:px-4 lg:py-2 H5" style={{margin : 0}} >{trump.toLocaleString()}</div>
    <h3 className="text-lg lg:text-2xl text-yellow-400 text-center"  style={{margin : 0}}>Your Contributions</h3>
    <div className="bg-green-700 rounded-3xl px-2 py-1 lg:px-4 lg:py-2 H5" style={{margin : 0}} >{biden.toLocaleString()}</div>
    </div>
}
