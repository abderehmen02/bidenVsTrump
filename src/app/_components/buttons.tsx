...
const onHoverStart = ()=>{
    ...
    return       <div className="w-full flex relative items-center justify-between" >
...
export const PageButtons = ()=>{
    return <div  className="flex py-3   px-1 lg:hidden w-full  relative  z-0  items-center justify-around" >
